...
import com.rarnu.devlib.component.event.OnScreenChangeListener;
import com.rarnu.devlib.component.event.OnScreenTouchListener;
...
public class VScrollLayout extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (widthMode != MeasureSpec.EXACTLY) {
			throw new IllegalStateException(getContext().getString(
					R.string.exception_not_exactly_mode));
		}
