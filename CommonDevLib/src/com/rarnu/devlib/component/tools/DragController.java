...
public class DragController extends FloatViewManager implements
	...
	public DragController(DragListView listview, int dragHandleId,
	...
	public DragController(DragListView listview, int dragHandleId,
		...
		mFlingRemoveDetector = new GestureDetector(listview.getContext(),
				mFlingRemoveListener);
		mFlingRemoveDetector.setIsLongpressEnabled(false);
		mTouchSlop = ViewConfiguration.get(listview.getContext())
				.getScaledTouchSlop();
	...
	public boolean startDrag(int position, int deltaX, int deltaY) {
		...
		mDragging = mListview.startDrag(
				position - mListview.getHeaderViewsCount(), dragFlags, deltaX,
				deltaY);
		return mDragging;
	}
	...
	public boolean onSingleTapUp(MotionEvent ev) {
		if (mRemoveEnabled && mRemoveMode == CLICK_REMOVE) {
			if (mClickRemoveHitPos != MISS) {
				mListview.removeItem(mClickRemoveHitPos
