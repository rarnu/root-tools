...
public class Texture {
	...
	public static Texture createTexture(Bitmap bitmap, FlipRenderer renderer,
			GL10 gl) {
		...
		case ARGB_8888:
			gl.glTexImage2D(GL10.GL_TEXTURE_2D, 0, GL10.GL_RGBA, potW, potH, 0,
					GL10.GL_RGBA, GL10.GL_UNSIGNED_BYTE, null);
			GLUtils.texSubImage2D(GL10.GL_TEXTURE_2D, 0, 0, 0, bitmap);
			break;
		case ARGB_4444:
			gl.glTexImage2D(GL10.GL_TEXTURE_2D, 0, GL10.GL_RGBA, potW, potH, 0,
					GL10.GL_RGBA, GL10.GL_UNSIGNED_SHORT_4_4_4_4, null);
			GLUtils.texSubImage2D(GL10.GL_TEXTURE_2D, 0, 0, 0, bitmap);
			break;
		case RGB_565:
			gl.glTexImage2D(GL10.GL_TEXTURE_2D, 0, GL10.GL_RGB, potW, potH, 0,
