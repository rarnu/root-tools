	...
	public void draw(GL10 gl) {
		...
		if (angle > 0) {
			...
			if (axis == AXIS_TOP) {
				if (orientationVertical) {
					h = (cardVertices[Y_00] - cardVertices[Y_01])
							* (1.0f - android.util.FloatMath.cos(Texture
									.d2r(angle)));
					z = (cardVertices[Y_00] - cardVertices[Y_01])
							* android.util.FloatMath.sin(Texture.d2r(angle));
					shadowVertices = new float[] { cardVertices[X_00],
							cardVertices[Y_01] + h, z, cardVertices[X_01],
							cardVertices[Y_01], 0f, cardVertices[X_11],
					...
					z = (cardVertices[X_10] - cardVertices[X_00])
							* android.util.FloatMath.sin(Texture.d2r(angle));
					shadowVertices = new float[] { cardVertices[X_10] - w,
							cardVertices[Y_00], z, cardVertices[X_11] - w,
							cardVertices[Y_01], z, cardVertices[X_11],
							cardVertices[Y_11], 0f, cardVertices[X_10],
							cardVertices[Y_10], 0f };
				}
			} else {
				if (orientationVertical) {
					h = (cardVertices[Y_00] - cardVertices[Y_01])
							* (1f - android.util.FloatMath.cos(Texture
									.d2r(angle)));
					z = (cardVertices[Y_00] - cardVertices[Y_01])
							* android.util.FloatMath.sin(Texture.d2r(angle));
					shadowVertices = new float[] { cardVertices[X_00],
							cardVertices[Y_00], 0f, cardVertices[X_01],
							cardVertices[Y_00] - h, z, cardVertices[X_11],
							cardVertices[Y_00] - h, z, cardVertices[X_10],
							cardVertices[Y_00], 0f };
				} else {
					w = (cardVertices[X_10] - cardVertices[X_00])
							* (1f - android.util.FloatMath.cos(Texture
									.d2r(angle)));
					...
					shadowVertices = new float[] { cardVertices[X_00],
							cardVertices[Y_00], 0f, cardVertices[X_01],
							cardVertices[Y_01], 0f, cardVertices[X_00] + w,
							cardVertices[Y_11], z, cardVertices[X_01] + w,
							cardVertices[Y_10], z };
				}
			}
			...
			gl.glVertexPointer(3, GL10.GL_FLOAT, 0,
					Texture.toFloatBuffer(shadowVertices));
			gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
					GL10.GL_UNSIGNED_SHORT, indexBuffer);
