...
public abstract class InnerAdapterView<T extends Adapter> extends ViewGroup {
	...
	public interface OnItemClickListener {
		void onItemClick(InnerAdapterView<?> parent, View view, int position,
				long id);
	}
	...
	public interface OnItemLongClickListener {
		boolean onItemLongClick(InnerAdapterView<?> parent, View view,
	...
	public interface OnItemSelectedListener {
		void onItemSelected(InnerAdapterView<?> parent, View view,
				int position, long id);
