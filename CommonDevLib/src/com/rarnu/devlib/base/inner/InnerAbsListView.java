...
public abstract class InnerAbsListView extends InnerAdapterView<ListAdapter>
	...
	public interface OnScrollListener {
		...
		public void onScroll(InnerAbsListView view, int firstVisibleItem,
		...
		if (longPressPosition >= 0) {
			...
			if (mOnItemLongClickListener != null) {
				handled = mOnItemLongClickListener.onItemLongClick(
						InnerAbsListView.this, originalView, longPressPosition,
						longPressId);
			}
			if (!handled) {
	...
	public void reclaimViews(List<View> views) {
		...
		for (int i = 0; i < childCount; i++) {
			...
			InnerAbsListView.LayoutParams lp = (InnerAbsListView.LayoutParams) child
					.getLayoutParams();
	...
	class RecycleBin {
		...
		void addScrapView(View scrap) {
			InnerAbsListView.LayoutParams lp = (InnerAbsListView.LayoutParams) scrap
					.getLayoutParams();
			if (lp == null) {
				return;
			}
		...
		void scrapActiveViews() {
			...
			for (int i = count - 1; i >= 0; i--) {
				...
				if (victim != null) {
					int whichScrap = ((InnerAbsListView.LayoutParams) victim
