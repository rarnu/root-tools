...
public class ImageAdapterDeprecated extends BaseAdapter {
	...
	public ImageAdapterDeprecated(Context c, LayoutInflater inflater, List<ArticleItem> list, ListView listview, Gallery gallery) {
		mContext = c;
		mList = list;
