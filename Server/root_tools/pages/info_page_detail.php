 ...
 <div class="container">
      ...
      <div class="hero-unit">
       <h3>全部功能列表(<a href="info_page.php">返回</a>)</h3>
        ...
        <tr><td width="5%">*</td><td width="95%"><b>防火墙</b><br>
        &nbsp;&nbsp;&nbsp;&nbsp;a) 禁用/启用应用程序对网络的访问权限</td></tr>
        <tr><td width="5%">*</td><td width="95%"><b>清理ROM</b><br>
        &nbsp;&nbsp;&nbsp;&nbsp;a) 自动化批量删除系统内置的第三方应用<br>
        &nbsp;&nbsp;&nbsp;&nbsp;<font color="RED">b) 增加对更多品牌机型的支持（计划中）</font></td></tr>
        <tr><td width="5%"></td><td width="95%"><hr style="border:1 dashed #987cb9" /></td></tr>
        ...
        <tr><td width="5%">*</td><td width="95%"><b>批量安装卸载</b><br>
        &nbsp;&nbsp;&nbsp;&nbsp;a) 批量静默安装应用程序<br>
        &nbsp;&nbsp;&nbsp;&nbsp;b) 批量静默卸载应用程</td></tr>
        <tr><td width="5%"></td><td width="95%"><hr style="border:1 dashed #987cb9" /></td></tr>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;d) 清理内存设置<br>
        &nbsp;&nbsp;&nbsp;&nbsp;e) 修改Hosts设置</td></tr>
        <tr><td width="5%">*</td><td width="95%"><b>系统组件</b><br>
        &nbsp;&nbsp;&nbsp;&nbsp;a) 展现系统内ROOT必备文件的安装状态<br>
        &nbsp;&nbsp;&nbsp;&nbsp;b) 为用户安装BUSYBOX不<br>
        &nbsp;&nbsp;&nbsp;&nbsp;c) 为用户安装IPTABLES</td></tr>
        <tr><td width="5%">*</td><td width="95%"><b>Google 套件</b><br>
        &nbsp;&nbsp;&nbsp;&nbsp;a) 检查系统内 Google 套件的安装情况<br>
        &nbsp;&nbsp;&nbsp;&nbsp;b) 列出不存在或是破损的文件<br>
        &nbsp;&nbsp;&nbsp;&nbsp;c) 为用户下载并安装 Google 套件</td></tr>
