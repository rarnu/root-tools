...
<title>RootTools App Recommand Page</title>
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <div class="container">
            ...
            <a class="brand" href="#">RootTools Admin</a>
            <div class="nav-collapse collapse">
              <ul class="nav">
		        <li><a href="upload_package.php">推广包上传</a></li>
                <li><a href="manage_package.php">推广包管理</a></li>
                <li><a href="order_package.php">推广包排序</a></li>
                ...
                <li><a href="upload_splash.php">上传开机画面</a></li>
