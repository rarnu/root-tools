...
public class RTConsts {
    ...
    public static final int REQCODE_SYSAPP = 1;
    public static final int REQCODE_DATA = 2;
    public static final int REQCODE_COMP = 3;
    public static final int REQCODE_MEMORY = 4;
    public static final int REQCODE_HOST = 5;
    ...
    public static final int REQCODE_AP_SELECT = 13;
