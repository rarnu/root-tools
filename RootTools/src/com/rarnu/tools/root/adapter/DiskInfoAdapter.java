...
public class DiskInfoAdapter extends BaseAdapter<DiskInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            ...
            holder.tvTotal.setText(context.getString(R.string.disk_size_fmt, item.size));
            holder.tvUsed.setText(Html.fromHtml(context.getString(R.string.disk_used_fmt, item.getColoredSize(0))));
            holder.tvFree.setText(Html.fromHtml(context.getString(R.string.disk_free_fmt, item.getColoredSize(1))));
            holder.tvBlock.setText(context.getString(R.string.disk_block_fmt, item.blockSize));
        }
        return v;
    }
