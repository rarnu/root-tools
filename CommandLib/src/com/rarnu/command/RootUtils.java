...
public class RootUtils {
	...
	public static boolean hasSuperuser() {
		...
		try {
			info = pm.getApplicationInfo(SUPERUSER_PATH_1, 0);
		...
		if (info == null) {
			try {
				info = pm.getApplicationInfo(SUPERUSER_PATH_2, 0);
			} catch (NameNotFoundException e) {
				info = null;
			}
		}
		...
		if (info == null) {
			try {
				info = pm.getApplicationInfo(SUPERUSER_PATH_3, 0);
			} catch (NameNotFoundException e) {
				info = null;
			}
		}
		...
		if (info == null) {
			try {
				info = pm.getApplicationInfo(SUPERUSER_PATH_4, 0);
			} catch (NameNotFoundException e) {
				info = null;
			}
		}
		...
		if (info == null) {
			try {
				info = pm.getApplicationInfo(SUPERUSER_PATH_5, 0);
			} catch (NameNotFoundException e) {
				info = null;
			}
		}
		...
		if (info == null) {
			try {
				info = pm.getApplicationInfo(SUPERUSER_PATH_6, 0);
			} catch (NameNotFoundException e) {
				info = null;
			}
		}
		...
		if (info == null) {
			try {
				info = pm.getApplicationInfo(SUPERUSER_PATH_7, 0);
			} catch (NameNotFoundException e) {
				info = null;
			}
		}
