...
public class FileUtils {
    ...
    public static void rewriteFile(String path, String text, String encoding) throws IOException {
        File myFile = new File(path);
    ...
    public static void appendFile(File file, String text, String encoding) throws IOException {
    ...
    public static void appendFile(String path, String text, String encoding) throws IOException {
        File myFile = new File(path);
    ...
    public static List<String> readAssertFileAsList(Context context, String fileName) throws IOException {
        InputStream is = context.getAssets().open(fileName);
    ...
    public static String readInnerFile(Context context, String path) throws IOException {
