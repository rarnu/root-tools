...
public class ProgressedMultipartEntity extends MultipartEntity {
    ...
    public ProgressedMultipartEntity(Part[] parts, HttpParams params, ProgressListener listener) {
        super(parts, params);
        this.listener = listener;
    }
    ...
    public static class CountingOutputStream extends FilterOutputStream {
        ...
        public CountingOutputStream(final OutputStream out, final ProgressListener callback) {
            super(out);
