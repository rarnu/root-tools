...
public class PackageParserUtils {
    ...
    public PackageParserUtils(String archivePath) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                Constructor<?> constructor = cPackageParser.getDeclaredConstructor(String.class);
                constructor.setAccessible(true);
                mPackageParser = constructor.newInstance(archivePath);
            }
    ...
    public Object parsePackage(String filePath, int flag) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                Method mParse = mPackageParser.getClass().getDeclaredMethod("parsePackage", File.class, String.class, DisplayMetrics.class, int.class);
                mParse.setAccessible(true);
                DisplayMetrics mMetrics = new DisplayMetrics();
                mMetrics.setToDefaults();
                mReturn = mParse.invoke(mPackageParser, sourceFile, filePath, mMetrics, flag);
            }
        } catch (Exception e) {
    ...
    public static class Component {
        ...
        public void fill(Object mComponent) {
            ...
            try {
                ...
                intents = (ArrayList<Object>) fIntents.get(mComponent);
            } catch (Exception e) {
            }
            try {
