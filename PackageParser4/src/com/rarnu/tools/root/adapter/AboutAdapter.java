...
public class AboutAdapter extends InnerAdapter<AboutInfo> {

	int[] fitableDrawable = new int[] { R.drawable.c0, R.drawable.c1,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (item != null) {
			...
			holder.imgFitable.setVisibility(item.fitable == -1 ? View.GONE
					: View.VISIBLE);
			if (item.fitable != -1) {
				holder.imgFitable
						.setImageResource(fitableDrawable[item.fitable]);
			}
		}
		return v;
	}
