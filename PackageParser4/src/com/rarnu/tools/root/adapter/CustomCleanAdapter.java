...
public class CustomCleanAdapter extends InnerAdapter<CustomPackageInfo> {

	private Handler h;

	public CustomCleanAdapter(Context context, List<CustomPackageInfo> list,
			Handler h) {
		super(context, list);
		this.h = h;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (holder == null) {
			...
			holder.itemNamespace = (TextView) v
					.findViewById(R.id.itemNamespace);
