...
import com.rarnu.zoe.loving.comp.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener {
	...
	private void initHeaderViewAndFooterViewAndListView(Context context) {
		...
		mListView.setDivider(new ColorDrawable(0xffc0c0c0));
		mListView.setDividerHeight(UIUtils.dipToPx(1));
	...
	private void checkHeaderViewState() {
		if (mHeaderViewParams.height >= DEFAULT_HEADER_VIEW_HEIGHT) {
			...
			mHeaderTextView.setText(R.string.release_fresh);
			...
			mHeaderTextView.setText(R.string.pulldown_refresh);
	...
	public boolean onListViewTopAndPullDown(int delta) {
		...
		Intent inEnableScroll = new Intent(Consts.SCROLL_MESSAGE_ACTION);
